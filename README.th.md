...
- **เรียกใช้ (Reuse):** agent เรียก skill เหล่านี้ในรอบถัดไป ทำให้ทำงานได้ดีขึ้นและสอดคล้องกับการตัดสินใจเดิมของมนุษย์ นอกจากนี้ยังตรวจ `docs/skill-drafts/` เพื่อดู skill ฉบับร่างที่รอมนุษย์นำไปใส่ไว้ที่ `.claude/skills/` และนำแนวทางในร่างนั้นมาใช้ระหว่างที่ยังรอการอนุมัติ
